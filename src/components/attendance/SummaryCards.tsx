...
export function SummaryCards({ workingDays, totalWorkMinutes, totalOvertimeMinutes, standardWorkMinutes }: Props) {
  const items = [
    ...
    { label: "所定労働", value: formatMinutes(standardWorkMinutes) + "/日" },
  ];
